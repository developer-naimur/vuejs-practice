...
const menus = ref([
  ...
  { label: 'Purchase Return', to: '/purchase-return' } // যেহেতু আগের link empty ছিল, এখন proper route add করলাম
])
</script>
...
<template>
  <!-- Sidebar (fixed) -->
  <div
    class="fixed top-[57px] left-[57px] h-screen bg-gray-50 flex flex-col p-6 w-[350px] border-r border-gray-200 z-50"
  >
