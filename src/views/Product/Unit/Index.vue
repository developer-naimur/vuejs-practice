...
const loadData = async () => {
  ...
  $rows.value = [
    { id: 1, name: 'Piece', status: 'Active' },
    { id: 2, name: 'Carton', status: 'Pending' },
    { id: 3, name: 'Box', status: 'Inactive' },
    { id: 4, name: 'Packet', status: 'Active' },
    { id: 5, name: 'Bundle', status: 'Pending' }
  ]
}
onMounted(loadData)
