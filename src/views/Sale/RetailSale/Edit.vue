...
<template>
  <div class="p-6 space-y-4">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-4">
      <h2 class="text-2xl font-semibold text-gray-700">Edit Sale</h2>
        ...
        <table class="w-full text-sm border">
          ...
          <tbody>
            <tr v-for="p in selectedProducts" :key="p.id">
              ...
              <td class="border px-2 py-1 text-center"><div class="flex justify-center">
				  <div class="flex border rounded overflow-hidden">
				    <!-- Minus Button -->
				    <button
				      @click="updateQty(p, 'minus')"
				      class="px-2 py-1 bg-red-500 text-white hover:bg-red-600 transition cursor-pointer"
				    >
				    ...
				    <button
				      ...
				      class="px-2 py-1 bg-green-500 text-white hover:bg-green-600 transition cursor-pointer"
				    >
				      <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3">
              ...
              <td class="border px-2 py-1 font-semibold">৳ {{ productSubtotal(p).toFixed(2) }}</td>
      ...
      <div class="bg-white rounded-xl shadow-xl max-w-6xl w-full h-[85vh] flex flex-col">
        ...
        <div class="flex-1 grid grid-cols-3 gap-4 p-4 overflow-hidden">
          ...
          <div class="col-span-2 border  overflow-hidden flex flex-col">
            <div class="bg-gray-100 px-4 py-2 font-semibold">Products</div>
