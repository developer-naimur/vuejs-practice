...
const breadcrumbs = [
  { label: 'Home', to: '/' },
  { label: 'Price Group Lists', to: '/setting/price-group' },
  { label: 'Price Group Trash Lists' }
]
  ...
  <div class="flex-1 lg:ml-[320px] p-4">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-4">
      ...
      <div class="flex flex-col md:flex-row items-start md:items-center gap-2">
        <h2 class="text-2xl font-semibold text-gray-700">Price Group Trash Lists</h2>
      ...
      <div class="flex gap-2 flex-wrap">
        ...
        <router-link to="/setting/price-group" class="flex items-center gap-2 px-4 py-2 rounded bg-gray-500 text-white hover:bg-gray-600 transition">
