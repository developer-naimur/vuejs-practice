...
const breadcrumbs = [
  { label: 'Home', to: '/' },
  { label: 'Role Lists', to: '/setting/user/role' },
  ...
  <div class="flex-1 lg:ml-[320px] p-4">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-4">
      ...
      <div class="flex gap-2 flex-wrap">
        ...
        <router-link to="/setting/user/role" class="flex items-center gap-2 px-4 py-2 rounded bg-gray-500 text-white hover:bg-gray-600 transition">
